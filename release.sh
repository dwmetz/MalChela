...
for tool in malchela fileminer mstrings hashit hashcheck mzcount mzhash xmzhash combine_yara strings_to_yara nsrlquery extract_samples about fileanalyzer MITRE_lookup tiquery plist_analyzer macho_info codesign_check; do
